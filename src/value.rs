...
macro_rules! math {
    ($self:expr, $other:expr, $op:tt, $op_name:expr, $op_plural:expr) => {
        return match($self, $other) {
            ...
            (Values::SIGNED(_), Values::STRUCT(_, _, _)) => panic!("cannot {} struct and a number", $op_name),
            ...
            (Values::UNSIGNED(_), Values::STRUCT(_, _, _)) => panic!("cannot {} struct and a number", $op_name),
            ...
            (Values::DECIMAL(_), Values::STRUCT(_, _, _)) => panic!("cannot {} struct and a number", $op_name),
            ...
            (Values::POINTER(_, _), Values::STRUCT(_, _, _)) => panic!("cannot {} struct and a pointer", $op_name),
            ...
            (Values::STRUCT(_, _, _), _) => panic!("struct cannot be {} to", $op_plural),
...
impl Values {
    pub fn set(&mut self, other: &Values) { // basically auto-type casting
        match(self, other) {
            ...
            (Values::SIGNED(_), Values::STRUCT(_, _, _)) => panic!("cannot set a number value as a struct"),
            ...
            (Values::UNSIGNED(_), Values::STRUCT(_, _, _)) => panic!("cannot set a number value as a struct"),
            ...
            (Values::DECIMAL(_), Values::STRUCT(_, _, _)) => panic!("cannot set a number value as a struct"),
            ...
            (Values::STRUCT(_, _, _), Values::TYPE(_)) => todo!(),
            (Values::STRUCT(_, _, _), Values::NAME(_)) => todo!(),
            ...
            (Values::TYPE(_), Values::STRUCT(_, _, _)) => todo!(),
            ...
            (Values::NAME(_), Values::STRUCT(_, _, _)) => panic!("cannot set a name value as a struct"),
    ...
    pub fn not(&self) -> Values {
        match self {
            ...
            Values::STRUCT(_, _, _) => panic!("cannot NOT a struct"),
