...
macro_rules! math {
    ($self:expr, $other:expr, $op:tt, $op_name:expr, $op_plural:expr) => {
        return match($self, $other) {
            ...
            (Values::SIGNED(s), Values::POINTER(v)) => Values::SIGNED(*s $op *v as i64),
            ...
            (Values::UNSIGNED(s), Values::POINTER(v)) => Values::UNSIGNED(*s $op *v as u64),
            ...
            (Values::DECIMAL(s), Values::POINTER(v)) => Values::DECIMAL(*s $op *v as f64),
            ...
            (Values::POINTER(s), Values::SIGNED(v)) => Values::POINTER(*s $op *v as usize),
            (Values::POINTER(s), Values::UNSIGNED(v)) => Values::POINTER(*s $op *v as usize),
            (Values::POINTER(s), Values::DECIMAL(v)) => Values::POINTER(*s $op *v as usize),
            (Values::POINTER(s), Values::POINTER(v)) => Values::POINTER(*s $op *v),
            (Values::POINTER(_), Values::STRUCT) => panic!("cannot {} struct and a pointer", $op_name),
            (Values::POINTER(_), Values::TYPE(_)) => panic!("cannot {} type and a pointer", $op_name),
            (Values::POINTER(_), Values::NAME(_)) => panic!("cannot {} name and a pointer", $op_name),
