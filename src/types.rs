...
pub fn cast_type(val: Box<Types>, t: u8) -> Box<Types> {
    match (val.as_ref(), t) {
        (Types::Void(_), 0x00) => Box::new(Types::Void(0)),
        (Types::Void(_), 0x01) => Box::new(Types::I8(0)),
        (Types::Void(_), 0x02) => Box::new(Types::I16(0)),
        (Types::Void(_), 0x03) => Box::new(Types::I32(0)),
        (Types::Void(_), 0x04) => Box::new(Types::I64(0)),
        (Types::Void(_), 0x05) => Box::new(Types::U8(0)),
        (Types::Void(_), 0x06) => Box::new(Types::U16(0)),
        (Types::Void(_), 0x07) => Box::new(Types::U32(0)),
        (Types::Void(_), 0x08) => Box::new(Types::U64(0)),
        (Types::Void(_), 0x09) => Box::new(Types::F16(f16::from_f32(0.0))),
        (Types::Void(_), 0x0A) => Box::new(Types::F32(0.0)),
        (Types::Void(_), 0x0B) => Box::new(Types::F64(0.0)),
        (Types::Void(_), 0x0C) => Box::new(Types::Pointer(0)),
        (Types::Void(_), 0x0D) => Box::new(Types::Type(0)),
        (Types::I8(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::I16(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::I32(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::U8(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::U16(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::U32(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::U64(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::F32(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::F64(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::Pointer(_), 0x00) => Box::new(Types::Void(0)),
        ...
        (Types::Type(_), 0x00) => Box::new(Types::Void(0)),
